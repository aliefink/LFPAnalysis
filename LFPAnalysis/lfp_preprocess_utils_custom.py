...
nan_artifacts_pre_epoch=True,detrend=None,save_path=None,subj_id=None):
    ...
    if save_path:
        bads_path = f'{save_path}{behav_name}/'
        os.makedirs(bads_path,exist_ok=True)
        if subj_id:
            IED_df.to_csv(f'{bads_path}/{subj_id}_{behav_name}_IED_df.csv')
            artifact_df.to_csv(f'{bads_path}/{subj_id}_{behav_name}_artifact_df.csv')
        else:
